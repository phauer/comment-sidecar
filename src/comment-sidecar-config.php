...
const ALLOWED_ACCESSING_SITES = [ "http://localhost:300", "http://localhost:3000" ]; # sites that are allowed to access the backend (required for multisite setups, where the backend is deployed on a different domain than the embedding site.)
