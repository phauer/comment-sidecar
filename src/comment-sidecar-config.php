...
const SITE = "localhost"; # key for this site to identity comment of this site
...
const ALLOWED_ACCESSING_SITES = [ "http://localhost:1313", "http://localhost:3000" ]; # sites that are allowed to access the backend (required for multisite setups, where the backend is deployed on a different domain than the embedding site.)
